...
def prepare_company_analytics(
    ...
    *,
    ...
    """Return a host-executable plan; portable code performs no retrieval."""
    ...
    if not isinstance(negotiation, Mapping) or execution_mode not in {"full", "compatible", "tools_only"}:
        raise ValueError("execution_mode must be one of: full, compatible, tools_only")
