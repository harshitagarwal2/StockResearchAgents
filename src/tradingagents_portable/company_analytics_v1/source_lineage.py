...
from tradingagents_portable.analytics_v1.common import validate_digest
...
class SourceLineageBindingV1(StrictModel):
    """One identity-preserving link from host observation to portable evidence."""
    ...
    def __post_init__(self) -> None:
        for path, value in (
            ...
            ("host_license_receipt_id", self.host_license_receipt_id),
...
class SourceLineageCrosswalkV1(StrictModel):
    """Complete source identity and entitlement bridge for one v4 publication."""
