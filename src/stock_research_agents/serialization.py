...
from typing import TYPE_CHECKING, Any, Literal, TypeVar, Union, cast, get_args, get_origin, get_type_hints
...
if TYPE_CHECKING:
    ...
    StoredResult = CompanyAnalyticsResultV1
else:
    StoredResult = Any

_T = TypeVar("_T")
_TYPE_MARKER = "__stock_research_agents_json_type__"
