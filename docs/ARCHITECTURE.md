...
| Application facade | `StockResearchApplication` plus completed-publication response/query services | Gives CLI and MCP one transport-neutral use-case boundary |
