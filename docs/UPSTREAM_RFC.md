...
- [full CI run](https://github.com/harshitagarwal2/tradingrearchagents/actions/runs/30797921465);
- [upstream no-change sync check](https://github.com/harshitagarwal2/tradingrearchagents/actions/runs/30798041036).
