...
- `company-request.v3.json` is a minimal deterministic request for planning an Evidence-First Company Research run.
...
Complete terminal submissions are intentionally not hand-maintained here. They are large, strictly linked artifacts produced and validated by the host. The deterministic conformance builders live under `tests/research_v3_fixtures.py`.
