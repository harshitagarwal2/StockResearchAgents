"""Deterministic, provider-free fixtures for complete company research submissions."""
...
def complete_research_submission(symbol: str) -> dict[str, object]:
            ...
            "coverage_dimensions": [
                {
                    ...
                    "entitlement_policy": "caller_entitled_allowed" if area == "licensed_consensus" else "public_only",
                }
