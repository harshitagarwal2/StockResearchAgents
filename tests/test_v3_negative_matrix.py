...
from tradingagents_portable.research_conformance import validate_research_dossier
...
def test_host_submission_rejects_exact_boundary_mismatch(case: str, mutate: Mutation, message: str) -> None:
    payload = complete_v3_submission("ORCL")
    mutate(payload)
...
def test_major_collection_references_reject_unknown_identifiers(
    ...
    payload = complete_v3_submission("BASE")
